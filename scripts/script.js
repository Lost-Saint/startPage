...
const quotes = [
  ...
  },
  {
    ...
    author: "Sumit Srivastava (me)",
  },
  {
    text: "Breaking up is like knocking over a Coke machine. You can’t do it in one push; you got to rock it back and forth a few times, and then it goes over.",
  ...
  {
    text: "Ted Striker: 'Surely you can’t be serious.' Dr. Rumack: 'I am serious. And don’t call me Shirley.'",
    author:
  ...
  {
    text: "You know you’ve reached middle age when you’re cautioned to slow down by your doctor, instead of by the police.",
    author: "Joan Rivers",
  },
  {
  ...
  {
    text: "Marriage is like an unfunny, tense version of Everybody Loves Raymond, but it doesn’t last 22 minutes. It lasts forever.",
    author: "Pete (Paul Rudd), Knocked Up",
  },
  {
    text: "Being a mom means never buying the right amount of produce. Either everyone suddenly loves grapes and a week’s worth are eaten in one afternoon, or fruit flies are congregating around my rotting bananas.",
